...
<style scoped>
  ...
  .content h1{width:2.18rem;height:1.35rem; background:url(../assets/images/login.jpg) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
  .content .login{width:3.0rem;height:0.38rem; margin:0 auto; margin-top:0.85rem;}
