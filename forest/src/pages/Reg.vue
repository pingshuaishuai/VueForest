...
<div class="content">
  ...
  <div class="footbox">
    <input type="button" value="注 册" class="login-btn" @click="reset"/>
...
body{ background:#f2f4f5;}
    ...
    .content .fhbtn a{ display:block;width:0.23rem;height:0.25rem; background:url(../assets/images/back.jpg) no-repeat 0 0; background-size:100%; margin-left:0.3rem;}
    .content h1{width:2.18rem;height:1.35rem; background:url(../assets/images/reg.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
    .content .login{width:3rem;height:0.38rem; margin:0 auto; margin-top:0.85rem;}
    .login a{width:3rem;height:0.38rem; font-size:0.3rem; line-height:0.38rem; float:left; color:#4c4f50; text-align:center;}
    .login span{ float:left;height:0.38rem; border-left:1px solid #4c4f50;}
    .content .login-box{ position:relative;}
    .content .login-box .lsolid{width:1.3rem;height:0.18rem; border-bottom:1px solid #4c4f50; position:absolute;top:0;left:0.1rem;}
    .content .login-box .rsolid{width:1.3rem;height:0.18rem; border-bottom:1px solid #4c4f50; position:absolute;top:0;right:0.1rem;}
